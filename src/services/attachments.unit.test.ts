...
describe('parseAttachments', () => {
  it('should parse a single attachment without annotations', () => {
    const content = '![Caption](/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000)';
    ...
    expect(result).toEqual([
      {
        ...
        caption: 'Caption',
        originalUrl: '/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000',
      },
    ]);
  });
...
![Second Image](/api/attachments.redirect?id=987f6543-a21b-4d3c-b456-426614174111)
  ...
  it('should parse attachments with annotations', () => {
    const content = '![Caption](/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000 =300x200)';
    const result = parseAttachments(content);
    ...
    expect(result).toEqual([
      {
        id: '123e4567-e89b-4d3c-a456-426614174000',
        caption: 'Caption',
        originalUrl: '/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000 =300x200',
        annotations: ' =300x200',
      },
    ]);
  });
  ...
  it('should handle empty captions', () => {
    const content = '![](/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000)';
    const result = parseAttachments(content);
...
![Second](./987f6543-a21b-4d3c-b456-426614174111.jpg =100x100)
    ...
    expect(result[1].relativePath).toBe('987f6543-a21b-4d3c-b456-426614174111.jpg');
...
describe('transformMarkdownToAttachments', () => {
  it('should transform existing attachment references back to URLs', () => {
    ...
    expect(result).toBe('![Caption](/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000)');
  });

  it('should preserve annotations during transformation', () => {
    const content = '![Caption](./123e4567-e89b-4d3c-a456-426614174000.png =400x300)';
    const images: ImageUploadInfo[] = [
      {
        caption: 'Caption',
        relativePath: '123e4567-e89b-4d3c-a456-426614174000.png',
    ...
    expect(result).toBe('![Caption](/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000 =400x300)');
  });
...
![Another Regular](./another.gif)
    ...
    expect(result).toContain('![Attachment](/api/attachments.redirect?id=123e4567-e89b-4d3c-a456-426614174000)');
